...
implements Logger {
    ...
    public void trace(String msg, Throwable t2) {
        this.recordEvent_0Args(Level.TRACE, null, msg, t2);
    }
    ...
    public void trace(Marker marker, String msg, Throwable t2) {
        this.recordEvent_0Args(Level.TRACE, marker, msg, t2);
    }
    ...
    public void debug(String msg, Throwable t2) {
        this.recordEvent_0Args(Level.DEBUG, null, msg, t2);
    }
    ...
    public void debug(Marker marker, String msg, Throwable t2) {
        this.recordEvent_0Args(Level.DEBUG, marker, msg, t2);
    }
    ...
    public void info(String msg, Throwable t2) {
        this.recordEvent_0Args(Level.INFO, null, msg, t2);
    }
    ...
    public void info(Marker marker, String msg, Throwable t2) {
        this.recordEvent_0Args(Level.INFO, marker, msg, t2);
    }
    ...
    public void warn(String msg, Throwable t2) {
        this.recordEvent_0Args(Level.WARN, null, msg, t2);
    }
    ...
    public void warn(Marker marker, String msg, Throwable t2) {
        this.recordEvent_0Args(Level.WARN, marker, msg, t2);
    }
    ...
    public void error(String msg, Throwable t2) {
        this.recordEvent_0Args(Level.ERROR, null, msg, t2);
    }
    ...
    public void error(Marker marker, String msg, Throwable t2) {
        this.recordEvent_0Args(Level.ERROR, marker, msg, t2);
    }

    private void recordEvent_0Args(Level level, Marker marker, String msg, Throwable t2) {
        this.recordEvent(level, marker, msg, null, t2);
    }
