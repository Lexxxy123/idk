...
extends CoreStatement {
            ...
            try {
                for (int i2 = 0; i2 < changes.length; ++i2) {
                    try {
                        ...
                        db.prepare(this);
                        changes[i2] = db.executeUpdate(this, null);
                        continue;
                    } catch (SQLException e2) {
                        throw new BatchUpdateException("batch entry " + i2 + ": " + e2.getMessage(), null, 0, changes, (Throwable)e2);
                    } finally {
    ...
    public void setFetchSize(int r2) throws SQLException {
