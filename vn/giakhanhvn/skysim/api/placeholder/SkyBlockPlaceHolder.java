 ...
 */
package vn.giakhanhvn.skysim.api.placeholder;
...
extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, String identifier) {
        ...
        if (player.isOnline()) {
            ...
            if (identifier.equals("atkSpeed")) {
                return SUtil.commaify(Double.valueOf(Math.min(100.0, statistics.getAttackSpeed().addAll())).intValue());
            }
    ...
    public String getEffectLoop(OfflinePlayer player) {
        ...
        User user = User.getUser(player.getUniqueId());
        if (user != null) {
            ArrayList pte = (ArrayList)user.getEffects();
