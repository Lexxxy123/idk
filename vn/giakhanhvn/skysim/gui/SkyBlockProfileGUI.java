...
extends GUI {
    ...
    public void onOpen(GUIOpenEvent e2) {
        ...
        this.set(GUIClickableItem.createGUIOpenerItem(GUIType.SKYBLOCK_MENU, e2.getPlayer(), ChatColor.GREEN + "Go Back", 48, Material.ARROW, ChatColor.GRAY + "To SkySim Menu"));
