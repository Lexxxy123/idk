...
extends SCommand {
    ...
    public void run(CommandSource sender, String[] args) {
        ...
        if (i2 > 8 && type == EnchantmentType.ULTIMATE_WISE) {
            this.send(ChatColor.RED + "Too high enchantment level! This enchantment is capped at level 8.");
            return;
        }
        if (i2 > 5 && (type == EnchantmentType.SOUL_EATER || type == EnchantmentType.LIFE_STEAL || type == EnchantmentType.AIMING || type == EnchantmentType.VAMPIRISM)) {
