...
public class FerocityCalculation {
    ...
    public static void activeFerocityTimes(Player p2, LivingEntity damaged, int finalDamage, boolean crit) {
        ...
        if (damaged instanceof EnderDragon) {
            ...
            int n2 = formula < 10.0 ? (finalDamage = finalDamage * 1) : (formula > 10.0 && formula < 15.0 ? (finalDamage = finalDamage - finalDamage * 90 / 100) : (formula > 15.0 && formula < 20.0 ? (finalDamage = finalDamage - finalDamage * 99 / 100) : (formula > 20.0 && formula <= 25.0 ? (int)((double)finalDamage - (double)finalDamage * 99.9 / 100.0) : (finalDamage = formula > 25.0 ? (finalDamage = finalDamage * 0) : (finalDamage = finalDamage * 1)))));
        }
