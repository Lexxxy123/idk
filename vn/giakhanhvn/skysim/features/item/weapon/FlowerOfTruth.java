        ...
        new BukkitRunnable(){
            ...
            public void run() {
                ...
                for (Entity e2 : armorStand1.getNearbyEntities(1.0, 1.0, 1.0)) {
                    ...
                    if (le.contains((LivingEntity)e2) || entity.isDead() || !(entity instanceof LivingEntity) || entity instanceof Player || entity instanceof EnderDragonPart || entity instanceof Villager || entity instanceof ArmorStand || entity instanceof Item || entity instanceof ItemFrame || entity.hasMetadata("GiantSword")) continue;
                    ...
                    ++this.entityhit;
                    int k2 = 0;
                    for (Entity e22 : armorStand1.getNearbyEntities(20.0, 20.0, 20.0)) {
                        if (!(e22 instanceof LivingEntity) || e22.isDead() || !(e22 instanceof LivingEntity) || e22 instanceof Player || e22 instanceof EnderDragonPart || e22 instanceof Villager || e22 instanceof ArmorStand || e22 instanceof Item || e22 instanceof ItemFrame || e22.hasMetadata("GiantSword")) continue;
                        ++k2;
                    }
                    if (k2 > 0) continue;
