            ...
            new BukkitRunnable(){
                ...
                public void run() {
                    ...
                    for (Entity e2 : stand.getNearbyEntities(1.0, 1.0, 1.0)) {
                        ...
                        if (!back && goBone.contains((LivingEntity)e2) || back && backBone.contains((LivingEntity)e2) || entity.isDead()) continue;
                        ...
                        if (!back) {
                            goBone.add((LivingEntity)e2);
                        } else {
                            backBone.add((LivingEntity)e2);
                        }
