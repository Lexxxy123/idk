 ...
 */
package vn.giakhanhvn.skysim.features.enchantment;
...
public class EnchantmentType {
    private static final Map<String, EnchantmentType> ENCHANTMENT_TYPE_CACHE = new HashMap<String, EnchantmentType>();
    ...
    public static final EnchantmentType EXECUTE = new EnchantmentType("Execute", "execute", "Increases damage by " + ChatColor.GREEN + "%s%" + Sputnik.trans(" &7for each percent of Health missing on your target. "), SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE);
    ...
    public static final EnchantmentType KNOCKBACK = new EnchantmentType("Knockback", "knockback", Sputnik.trans("Increases knockback by &a%s&7 blocks."), Enchantment.KNOCKBACK, SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE);
    public static final EnchantmentType AQUA_INFINITY = new EnchantmentType("Aqua Infinity", "aqua_infinity", Sputnik.trans("Increases underwater mining rate to normal level mining rate."), Enchantment.WATER_WORKER, SpecificItemType.HELMET);
    public static final EnchantmentType VAMPIRISM = new EnchantmentType("Vampirism", "vampirism", Sputnik.trans("Heals for &a%s% &7of your missing Health per level whenever you kill an enemy."), SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE);
    public static final EnchantmentType FIRST_STRIKE = new EnchantmentType("First Strike", "first_strike", Sputnik.trans("Increases the first melee damage dealt to a mob by &a%s%"), SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE);
    public static final EnchantmentType VICIOUS = new EnchantmentType("Vicious", "vicious", Sputnik.trans("Grant &c+%s\u2afd Ferocity"), SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE, SpecificItemType.BOW);
    ...
    public static final EnchantmentType FATAL_TEMPO = new EnchantmentType("Fatal Tempo", "fatal_tempo", Sputnik.trans("&7Attack increases your &c\u2afd &cFerocity &7by &c%s% &7per hit, capped at &c200% &7for 3 seconds after your &efirst &eattack &7that triggers the enchantment."), true, SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE);
    ...
    public static final EnchantmentType LUCKINESS = new EnchantmentType("Luckiness", "luckiness", Sputnik.trans("&7Grant &b+%s \u272f Magic Find"), SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.SHOVEL, SpecificItemType.SHEARS, SpecificItemType.PICKAXE, SpecificItemType.BOW, SpecificItemType.AXE, SpecificItemType.ROD, SpecificItemType.HOE, SpecificItemType.HELMET, SpecificItemType.CHESTPLATE, SpecificItemType.LEGGINGS, SpecificItemType.BOOTS);
    public static final EnchantmentType SOUL_EATER = new EnchantmentType("Soul Eater", "soul_eater", Sputnik.trans("Your weapon gains &c%sx&7 damage of the latest monster killed and applies it on your next hit."), true, SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE, SpecificItemType.BOW);
    public static final EnchantmentType CHIMERA = new EnchantmentType("Chimera", "chimera", Sputnik.trans("Copies &a%s% &7of your active pet's stats."), true, SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE, SpecificItemType.BOW);
    public static final EnchantmentType LEGION = new EnchantmentType("Legion", "legion", Sputnik.trans("Increases most of your player stats by &e+%s% &7per player per level within &b30 &7blocks of you, up to &a20 &7players."), true, SpecificItemType.HELMET, SpecificItemType.CHESTPLATE, SpecificItemType.LEGGINGS, SpecificItemType.BOOTS);
    public static final EnchantmentType ONE_FOR_ALL = new EnchantmentType("One for All", "one_for_all", Sputnik.trans("Removes all other enchants but increases your weapon damage by &a%s%"), true, SpecificItemType.SWORD, SpecificItemType.LONGSWORD, SpecificItemType.AXE);
    ...
    public boolean equals(Object o2) {
        if (!(o2 instanceof EnchantmentType)) {
            return false;
        }
        return ((EnchantmentType)o2).namespace.equals(this.namespace);
    }
