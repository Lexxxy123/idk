...
public class WatcherTear
extends BaseZombie {
    @Override
    public String getEntityName() {
        return Sputnik.trans("&4&lMaster Tear");
    }
    ...
    public void onSpawn(final LivingEntity entity, SEntity sEntity) {
        HeadsOnWall h2 = new HeadsOnWall(EnumWatcherType.TEAR);
    ...
    public SEntityEquipment getEntityEquipment() {
        return new SEntityEquipment(SItem.of(SMaterial.STONE_SWORD).getStack(), null, SItem.of(SMaterial.CHAINMAIL_CHESTPLATE).getStack(), SItem.of(SMaterial.LEATHER_LEGGINGS).getStack(), SItem.of(SMaterial.CHAINMAIL_BOOTS).getStack());
    }
    ...
    public void onDamage(SEntity sEntity, Entity damager, EntityDamageByEntityEvent e2, AtomicDouble damage) {
        ...
        SUtil.delay(() -> WatcherTear.lambda$onDamage$0((Entity)en, v2), 1L);
    }
