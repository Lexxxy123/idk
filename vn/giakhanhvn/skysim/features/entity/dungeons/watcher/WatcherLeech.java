...
extends BaseZombie {
    ...
    public void onSpawn(final LivingEntity entity, SEntity sEntity) {
        HeadsOnWall h2 = new HeadsOnWall(EnumWatcherType.LEECH);
    ...
    public void onDamage(SEntity sEntity, Entity damager, EntityDamageByEntityEvent e2, AtomicDouble damage) {
        ...
        SUtil.delay(() -> WatcherLeech.lambda$onDamage$0((Entity)en, v2), 1L);
    }

    @Override
    public void onAttack(EntityDamageByEntityEvent e2) {
        ((LivingEntity)e2.getDamager()).setHealth(Math.min(((LivingEntity)e2.getDamager()).getMaxHealth(), ((LivingEntity)e2.getDamager()).getHealth() + 50000.0));
    }
