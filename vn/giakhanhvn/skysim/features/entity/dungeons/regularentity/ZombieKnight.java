...
extends BaseZombie {
    ...
    public void onAttack(EntityDamageByEntityEvent e2) {
        ((LivingEntity)e2.getDamager()).setHealth(Math.min(((LivingEntity)e2.getDamager()).getMaxHealth(), ((LivingEntity)e2.getDamager()).getHealth() + ((LivingEntity)e2.getDamager()).getMaxHealth() * 1.0 / 100.0));
    }
