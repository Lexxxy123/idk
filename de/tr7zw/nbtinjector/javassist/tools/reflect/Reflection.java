...
import de.tr7zw.nbtinjector.javassist.tools.reflect.CannotReflectException;
...
implements Translator {
    ...
    static final String metaobjectClassName = "de.tr7zw.nbtinjector.javassist.tools.reflect.Metaobject";
    static final String classMetaobjectClassName = "de.tr7zw.nbtinjector.javassist.tools.reflect.ClassMetaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        this.classPool = pool;
        String msg = "de.tr7zw.nbtinjector.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c2 = this.classPool.get("de.tr7zw.nbtinjector.javassist.tools.reflect.Sample");
            ...
            throw new RuntimeException("de.tr7zw.nbtinjector.javassist.tools.reflect.Sample is not found or broken.");
    ...
    private boolean modifyClassfile(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, NotFoundException {
        ...
        CtClass mlevel = this.classPool.get("de.tr7zw.nbtinjector.javassist.tools.reflect.Metalevel");
