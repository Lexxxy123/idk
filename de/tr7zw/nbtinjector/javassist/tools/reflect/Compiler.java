...
import de.tr7zw.nbtinjector.javassist.tools.reflect.CompiledClass;
    ...
    private static void processClasses(CompiledClass[] entries, int n2) throws Exception {
        ...
        for (i2 = 0; i2 < n2; ++i2) {
            ...
            if (entries[i2].metaobject != null || entries[i2].classobject != null) {
                String metaobj = entries[i2].metaobject == null ? "de.tr7zw.nbtinjector.javassist.tools.reflect.Metaobject" : entries[i2].metaobject;
                String classobj = entries[i2].classobject == null ? "de.tr7zw.nbtinjector.javassist.tools.reflect.ClassMetaobject" : entries[i2].classobject;
