...
import de.tr7zw.nbtinjector.javassist.bytecode.DuplicateMemberException;
...
import de.tr7zw.nbtinjector.javassist.util.proxy.FactoryHelper;
import de.tr7zw.nbtinjector.javassist.util.proxy.MethodFilter;
import de.tr7zw.nbtinjector.javassist.util.proxy.MethodHandler;
import de.tr7zw.nbtinjector.javassist.util.proxy.Proxy;
import de.tr7zw.nbtinjector.javassist.util.proxy.ProxyObject;
import de.tr7zw.nbtinjector.javassist.util.proxy.RuntimeSupport;
import de.tr7zw.nbtinjector.javassist.util.proxy.SecurityActions;
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "de.tr7zw.nbtinjector.javassist.util.proxy.RuntimeSupport";
    ...
    private static final String packageForJavaBase = "de.tr7zw.nbtinjector.javassist.util.proxy.";
