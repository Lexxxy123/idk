...
import de.tr7zw.nbtinjector.javassist.bytecode.ByteStream;
...
public class ClassFileWriter {
    ...
    public byte[] end(int accessFlags, int thisClass, int superClass, int[] interfaces, AttributeWriter aw2) {
        this.constPool.end();
        ...
        ClassFileWriter.writeAttribute(this.output, aw2, 0);
        return this.output.toByteArray();
    }

    public void end(DataOutputStream out, int accessFlags, int thisClass, int superClass, int[] interfaces, AttributeWriter aw2) throws IOException {
        this.constPool.end();
        ...
        if (aw2 == null) {
            ...
            out.writeShort(aw2.size());
            aw2.write(out);
        }
    }

    static void writeAttribute(ByteStream bs, AttributeWriter aw2, int attrCount) {
        if (aw2 == null) {
            bs.writeShort(attrCount);
            return;
        }
        bs.writeShort(aw2.size() + attrCount);
    ...
    public static final class MethodWriter {
        ...
        public void begin(int accessFlags, String name, String descriptor, String[] exceptions, AttributeWriter aw2) {
            ...
            this.begin(accessFlags, nameIndex, descIndex, intfs, aw2);
        }

        public void begin(int accessFlags, int name, int descriptor, int[] exceptions, AttributeWriter aw2) {
            int attrCount;
            ++this.methodCount;
            this.output.writeShort(accessFlags);
            this.output.writeShort(name);
            ...
            ClassFileWriter.writeAttribute(this.output, aw2, attrCount);
            if (exceptions != null) {
        ...
        public void end(StackMapTable.Writer smap, AttributeWriter aw2) {
            if (this.isAbstract) {
                return;
            }
    ...
    public static final class FieldWriter {
        ...
        public void add(int accessFlags, String name, String descriptor, AttributeWriter aw2) {
            int nameIndex = this.constPool.addUtf8Info(name);
            int descIndex = this.constPool.addUtf8Info(descriptor);
            this.add(accessFlags, nameIndex, descIndex, aw2);
        }

        public void add(int accessFlags, int name, int descriptor, AttributeWriter aw2) {
            ++this.fieldCount;
            this.output.writeShort(accessFlags);
            this.output.writeShort(name);
            this.output.writeShort(descriptor);
